...
#' @description Función para obtener imágenes L3 a partir de imágenes L2 descargadas desde https://oceancolor.gsfc.nasa.gov/cgi/browse.pl. Solo se pueden extraer archivos diarios, mensuales o anuales
...
#' @param season temporalidad para la generación de L3 ("day",  "month", "year" por ahora)
...
#' }
getL3_fix_season <- function(dir_ocssw, dir_input, dir_output, var_name, season, n_cores = 1, res_l2 = "1", res_l3 = "1Km", north, south, west, east, fudge, area_weighting) {
  tic()
  current_wd <- getwd()
